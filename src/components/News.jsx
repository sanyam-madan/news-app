...
export class News extends Component {
 ...
 async componentDidMount(){
    let url = " https://newsapi.org/v2/top-headlines?country=us&apiKey=5f19e5e69ff044d4b22df64f003b5302&page=1&pageSize=20"
  ...
  handlePrevClick = async ()=>{
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=5f19e5e69ff044d4b22df64f003b5302&pageSize=20&page=${this.state.page -1}`
    let data = await fetch(url)
    let parsedData = await data.json()
    console.log(parsedData)
    this.setState({
